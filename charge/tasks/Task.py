...
class Task(ABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        !!! note "Automatic MCP generation is an experimental feature and may not work as expected."
        
            All decorated methods must have proper type annotations and be static.
